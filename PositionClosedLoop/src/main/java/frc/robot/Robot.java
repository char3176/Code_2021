...
public class Robot extends TimedRobot {
    /** Hardware */
	TalonSRX _talon = new WPI_TalonSRX(33);
	...
	void commonLoop() {
		...
		if (!_lastButton1 && button1) {
			...
			targetPositionRotations = _talon.getSelectedSensorPosition(0) +.25*4096;/*leftYstick * 10.0 * 4096;*/
		...
		if (button2) {
			/* Percent Output */
			targetPositionRotations = _talon.getSelectedSensorPosition(0) +.25*4096;;
			_talon.set(ControlMode.Position, targetPositionRotations);
