...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    SmartDashboard.putNumber("A Button RPM", aButtonSpeed);
    SmartDashboard.putNumber("B Button RPM", bButtonSpeed);
    SmartDashboard.putNumber("Y Button RPM", yButtonSpeed);
    SmartDashboard.putNumber("X Button RPM", xButtonSpeed);
  }
  ...
  public void teleopPeriodic() {
    ...
    int aB = (int) SmartDashboard.getNumber("A Button RPM", 0);
    int bB = (int) SmartDashboard.getNumber("B Button RPM", 0);
    int xB = (int) SmartDashboard.getNumber("X Button RPM", 0);
    int yB = (int) SmartDashboard.getNumber("Y Button RPM", 0);
    ...
    if(aB != aButtonSpeed) { aButtonSpeed = aB; }
    if(bB != bButtonSpeed) { bButtonSpeed = bB; }
    if(xB != xButtonSpeed) { xButtonSpeed = xB; }
    if(yB != yButtonSpeed) { yButtonSpeed = yB; }
