...
public class Constants {
	...
	public static final int angledShooter_iZone = 1; //Isnt used in the AngledShooter
	public static final double angledShooter_PeakOutput = 1.0; //Isnt used in the AngledShooter
