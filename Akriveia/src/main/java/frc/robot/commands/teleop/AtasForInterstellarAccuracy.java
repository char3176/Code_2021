...
public class AtasForInterstellarAccuracy extends CommandBase {
  ...
  public AtasForInterstellarAccuracy(){}
  ...
  public boolean isFinished(){
    return !m_VisionClient.isAtasOn();
  }
}
